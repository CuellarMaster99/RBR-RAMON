// =====================================================
//   ARDUINO UNO — PID DUAL + TB6612FNG
...
//   ENCODERS
//   ─────────────────────────────────────────────
//   ⚠ El Arduino Uno SOLO tiene 2 interrupciones
//     externas: pines 2 (INT0) y 3 (INT1)
...
// ── Pines encoders ──
#define ENC1A  2    // INT0 — OBLIGATORIO para interrupción
#define ENC1B  4    // lectura digital en ISR
#define ENC2A  3    // INT1 — OBLIGATORIO para interrupción
#define ENC2B  12   // lectura digital en ISR

// ── Encoder ──
// Ajusta según tu encoder (ej: 20, 100, 234...)
const int PPR = 234;
...
// fixSign=false → cuadratura del encoder
bool fixSign = true;
...
//  Sin comandos de Python en WATCHDOG_MS → STOP
// =====================================================
...
void loop() {
  ...
  // Watchdog — sin comandos → STOP de seguridad
...
// =====================================================
//  TELEMETRÍA — mismo formato que ESP32 v4.0
//  Compatible con el dashboard Python sin cambios
// =====================================================
void printData() {
...
// =====================================================
//  ISR ENCODERS
//  Sin IRAM_ATTR (no existe en Uno — es macro ESP32)
// =====================================================
...
void printHelp() {
  Serial.println("\n+-----------------------------------------------+");
  Serial.println("|  Arduino Uno — PID Dual  TB6612FNG            |");
